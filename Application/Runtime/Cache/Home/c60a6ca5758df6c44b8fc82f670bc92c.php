...
<div id="main">
	...
	<p>热销中....</p>
		<?php if(is_array($hotlist)): foreach($hotlist as $key=>$vv): ?><div class="good newgood">
				...
				<div><a href="/newshop/Home/goods/detail?gid=<?php echo ($vv["id"]); ?>"><?php echo ($vv["name"]); ?></a></div>
				<div>[热销]<span>&nbsp;&nbsp;¥<?php echo ($vv["shop_price"]); ?>&nbsp;&nbsp;<a href="/newshop/Home/Flow/add?goods_id=<?php echo ($vv["id"]); ?>">购买</a></span></div>
			</div><?php endforeach; endif; ?>
	</div>
</div>
