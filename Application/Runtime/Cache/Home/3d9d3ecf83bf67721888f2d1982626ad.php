...
<h2>用户注册</h2>
<div id="container">
<form action="/newshop/Index.php/Home/User/register" method="post" content-type="application/x-www-form-urlencoded" onsubmit="return checkCapcha();">
...
<div class="reg"><label for="captcha">验证码:</label><input type="text" id="captcha" name="captcha"/><img id="captcha_img" src="/newshop/Index.php/Home/User/verifyImg" onclick="chimg();"/><span class="help-block"></span></div>
...
function chimg() {
            ...
            img.src="/newshop/Index.php/Home/User/verifyImg?qs="+Math.random();
        }
...
function checkCapcha(){
    ...
    var state = '';
    $.ajax({
        url:"/newshop/Index.php/Home/User/checkCaptcha",
        type:"get",
